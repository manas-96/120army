...
class Levelwidget extends StatelessWidget {
  const Levelwidget({super.key, this.own = true});
  final bool own;

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<RewardslevelBloc, RewardslevelState>(
      builder: (context, state) {
        if (state is RewardslevelLoading) {
          return Editprofileloader();
        } else if (state is RewardslevelLoaded) {
          return Container(
            ...
            child: Wrap(
              ...
              children: List.generate(state.model.data.length, (index) {
                int istotalcompleted = state.model.data[index].isTotalCompleted;
        ...
        } else if (state is RewardslevelError) {
